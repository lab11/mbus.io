...
Printed Name ___________________________
    ...
    <ul>
      ...
      <li>Commercial derivative works (e.g. MBus without the reserved
      arbitration edge) are prohibited</li>
      <ul>
        <li>Non-commercial (e.g. academic) derivatives are fine (encouraged!)</li>
        <li>If you have a substantive improvement / fix / etc, <a
          href="mailto:mbus-team@umich.edu">contact the MBus team</a> and we
        will work it into the specification</li>
      </ul>
    </ul>
    ...
    <div class="row hidden-xs">
      <div class="col-lg-3">
        <form method="get" action="/spec.html">
          <button type="submit" class="btn btn-default form-control">Cancel</button>
        </form>
      </div>
      <div class="col-lg-3">
        <form method="get" action="${legal}">
          <button type="submit" class="btn btn-default form-control">Legal Agreement (pdf)</button>
        </form>
      </div>
      <div class="col-lg-3">
